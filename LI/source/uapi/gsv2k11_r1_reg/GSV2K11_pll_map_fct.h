...
#define GSV2K11_PLL_get_TXA_PLL_ENABLE_MAN_EN(port, pval)              AvHalI2cReadField8(GSV2K11_PLL_MAP_ADDR(port), 0x83, 0x1, 0x0, pval)
#define GSV2K11_PLL_set_TXA_PLL_ENABLE_MAN_EN(port, val)               AvHalI2cWriteField8(GSV2K11_PLL_MAP_ADDR(port), 0x83, 0x1, 0x0, val)
