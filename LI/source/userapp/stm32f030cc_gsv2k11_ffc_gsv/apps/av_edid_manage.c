...
static const uint8 EdidVesaRangeLimit[] =  {0x00,0x00,0x00,0xFD,0x00,0x32,0x4B,0x0F,0x87,0x0F,0x01,0x0A,0x20,0x20,0x20,0x20,0x20,0x20};
static const uint8 EdidVesaProductName[] =  {0x00,0x00,0x00,0xFC,0x00,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20};
...
/* EDID Function Declare Start */
    ...
    void AvEdidFuncVesaProcess(AvEdidReg *EdidReg,uint8 *InEdid,uint8 *SinkEdid,uint8 *OutEdid)
    {
        ...
        {
            OutEdid[24] = 0x02;
            if((AvEdidSupportDpm & AvEdidBitDpmStandby) && (EdidVesaVersion[1] == 0x04))
            {
