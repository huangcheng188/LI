    ...
    if(*Port->content.is_CecFsm != OldState)
    {
        switch (*Port->content.is_CecFsm)
        {
          ...
          case AvFsmTvCmdGivePhysicalAddress:
            AvUapiOutputDebugFsm("Port%d: TvCmdGivePhysicalAddress", Port->index);
            break;
          case AvFsmTvFunctionalDefault:
            AvUapiOutputDebugFsm("Port%d: TvFunctionalDefault", Port->index);
            break;
          case AvFsmTvAudioModeStatus:
            AvUapiOutputDebugFsm("Port%d: TvAudioModeStatus", Port->index);
            break;
          case AvFsmTvCmdARCActive:
            AvUapiOutputDebugFsm("Port%d: TvCmdARCActive", Port->index);
            break;
          case AvFsmTvCmdARCInactive:
            AvUapiOutputDebugFsm("Port%d: TvCmdARCInactive", Port->index);
            break;
          case AvFsmTvCmdVendorID:
            AvUapiOutputDebugFsm("Port%d: TvCmdVendorID", Port->index);
            break;
          case AvFsmTvDefault:
            AvUapiOutputDebugFsm("Port%d: TvDefault", Port->index);
            break;
          case AvFsmTvIdle:
            AvUapiOutputDebugFsm("Port%d: TvIdle", Port->index);
            break;
          case AvFsmTvNotConnected:
            AvUapiOutputDebugFsm("Port%d: TvNotConnected", Port->index);
            break;
          case AvFsmTvReset:
            AvUapiOutputDebugFsm("Port%d: TvReset", Port->index);
            break;
          case AvFsmTvTxLogAddr:
            AvUapiOutputDebugFsm("Port%d: TvTxLogAddr", Port->index);
            break;
#endif
        }
    }
