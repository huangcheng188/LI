...
kapi AvRet AvApiPortMemAllocate(pin AvPort *port)
{
    ...
    switch(port->type)
    {
        case HdmiRx:
        {
            ...
            AvUapiAllocateMemory(sizeof(uint8),     (void **)&(port->content.is_HdcpFsm));
            AvUapiAllocateMemory(sizeof(uint8),     (void **)&(port->content.is_active_HdcpFsm));
        ...
        case LogicVideoRx:
        {
            ...
            AvUapiAllocateMemory(sizeof(RxVars),   (void **)&(port->content.rx));
            AvUapiAllocateMemory(sizeof(AvVideo),  (void **)&(port->content.video));
            AvUapiAllocateMemory(sizeof(AvLogicVideo),(void **)&(port->content.lvrx));
            break;
        }
#endif
        case LogicAudioRx:
